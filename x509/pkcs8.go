...
func MarshalPKCS8PrivateKey(key any) ([]byte, error) {
	...
	case *sm2.PrivateKey:
		...
		if privKey.PrivateKey, err = pkcs12.MarshalECPrivateKey(k); err != nil {
			return nil, errors.New("x509: failed to marshal SM2 EC private key while building PKCS#8: " + err.Error())
		}
