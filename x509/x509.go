...
func (algo SignatureAlgorithm) hashFunc() local.Hash {
	for _, details := range signatureAlgorithmDetails {
		if details.algo == algo {
			return details.hash
		}
...
var signatureAlgorithmDetails = []struct {
	...
	{MD5WithRSA, "MD5-RSA", oidSignatureMD5WithRSA, asn1.NullRawValue, RSA, local.MD5, false},
	{SHA1WithRSA, "SHA1-RSA", oidSignatureSHA1WithRSA, asn1.NullRawValue, RSA, local.SHA1, false},
	{SHA1WithRSA, "SHA1-RSA", oidISOSignatureSHA1WithRSA, asn1.NullRawValue, RSA, local.SHA1, false},
	{SHA256WithRSA, "SHA256-RSA", oidSignatureSHA256WithRSA, asn1.NullRawValue, RSA, local.SHA256, false},
	{SHA384WithRSA, "SHA384-RSA", oidSignatureSHA384WithRSA, asn1.NullRawValue, RSA, local.SHA384, false},
	{SHA512WithRSA, "SHA512-RSA", oidSignatureSHA512WithRSA, asn1.NullRawValue, RSA, local.SHA512, false},
	{SHA256WithRSAPSS, "SHA256-RSAPSS", oidSignatureRSAPSS, pssParametersSHA256, RSA, local.SHA256, true},
	{SHA384WithRSAPSS, "SHA384-RSAPSS", oidSignatureRSAPSS, pssParametersSHA384, RSA, local.SHA384, true},
	{SHA512WithRSAPSS, "SHA512-RSAPSS", oidSignatureRSAPSS, pssParametersSHA512, RSA, local.SHA512, true},
	{DSAWithSHA1, "DSA-SHA1", oidSignatureDSAWithSHA1, emptyRawValue, DSA, local.SHA1, false},
	{DSAWithSHA256, "DSA-SHA256", oidSignatureDSAWithSHA256, emptyRawValue, DSA, local.SHA256, false},
	{ECDSAWithSHA1, "ECDSA-SHA1", oidSignatureECDSAWithSHA1, emptyRawValue, ECDSA, local.SHA1, false},
	{ECDSAWithSHA256, "ECDSA-SHA256", oidSignatureECDSAWithSHA256, emptyRawValue, ECDSA, local.SHA256, false},
	{ECDSAWithSHA384, "ECDSA-SHA384", oidSignatureECDSAWithSHA384, emptyRawValue, ECDSA, local.SHA384, false},
	{ECDSAWithSHA512, "ECDSA-SHA512", oidSignatureECDSAWithSHA512, emptyRawValue, ECDSA, local.SHA512, false},
	{PureEd25519, "Ed25519", oidSignatureEd25519, emptyRawValue, Ed25519, local.Hash(0) /* no pre-hashing */, false},

	// Modify------------------------------------------
	{SM2WithSM3, "SM2-SM3", oidSignatureSM2WithSM3, emptyRawValue, ECDSA, local.SM3, false},
	{SM2WithSHA1, "SM2-SHA1", oidSignatureSM2WithSHA1, emptyRawValue, ECDSA, local.SHA1, false},
	{SM2WithSHA256, "SM2-SHA256", oidSignatureSM2WithSHA256, emptyRawValue, ECDSA, local.SHA256, false},
	// Modify------------------------------------------
}
...
func signTBS(tbs []byte, key crypto.Signer, sigAlg SignatureAlgorithm, rand io.Reader) ([]byte, error) {
	...
	case SM2WithSM3, SM2WithSHA1, SM2WithSHA256:
		...
		// 为了不入侵标准库ecdsa包，只能类型强转
		// 如果不是*sm2.PrivateKey类型
		// 先类型断言*ecdsa.PrivateKey
		// 然后转换成国密SK
		...
		if !ok {
			...
			if !ok {
				return nil, errors.New("x509: the type of the key is unknown")
			}

			var pk sm2.PublicKey
			pk.Curve = ecKey.Curve
			pk.X = ecKey.X
			pk.Y = ecKey.Y
		...
		signature, err = sm2Key.Sign(rand, signed, nil)
		if err != nil {
			return nil, err
		}
